...
// WorkTab/WorkTab/Job_Extensions.cs
...
namespace WorkTab {
    ...
    public static class Job_Extensions {
        public const  string                        DEFAULT_JOB_ICON_PATH = "UI/Icons/Various/unknown";
        ...
        private static void Initialize() {
            ...
            DefaultJobIcon = ContentFinder<Texture2D>.Get(DEFAULT_JOB_ICON_PATH);
        }

        public static Texture2D StatusIcon(this JobDef job) {
            return JobIcons.TryGetValue(job, out Texture2D icon) ? icon : DefaultJobIcon;
        }
    }
}
